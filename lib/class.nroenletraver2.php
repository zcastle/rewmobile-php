...
private $partedecimal;
    ...
    if ($numero==0||$numero==""){return "cero";}
    elseif ($numero<100)
    {                
      if($numero<=20)
	    ...
	    {
        $dec=$numero/10;
        if((int)$dec>2 && $numero%10!=0)$espacio=" y ";
        $unid= $numero%10;
    ...
    else
    {
      ...
      if($numero%100>20)
      {
        ...
        if((int)$dec>2 && ($numero%100)%10)$espacio=" y ";
	...
	public function getLetra()
	{
		...
		else{return $this->letra;}
	}
	private function nrosRaros($raros)
	{
	  if($raros=="ciento ")$raros="cien";
      return $raros;
  	}
      ...
      switch ($posicion)
      {
        case 0:
          	...
          	break;
        case 1:
      		if($literal==""||$literal=="cero"){$devolver=$nronombre[0];break;}
        ...
        case 3:
          	...
          	{
          		if($anterior=="cero"){$devolver=$nronombre[0];break;}
          		else {$devolver=$nronombre[0]." ".$nronombre[3];break;}
          	}	
          	$literal=str_replace("uno","un",$literal);
          	if($literal=="un"){$devolver=$literal." ".$nronombre[2];break;}
          	else{
          	/*if($anterior=="cero"){$devolver=$literal." ".$nronombre[2];break;}
          	else {*/$devolver=$literal." ".$nronombre[3];break;}
          //}
        case 4:
          	if($literal==""||$literal=="cero"){$devolver=$nronombre[0];break;}
           	$literal=str_replace("uno","un",$literal);
        ...
        case 5:
          	...
          	{
          		if($anterior=="cero"){$devolver=$nronombre[0];break;}
          		else {$devolver=$nronombre[0]." ".$nronombre[5];break;}
          	}         
          	$literal=str_replace("uno","un",$literal);
      		if($literal=="un"){$devolver=$literal." ".$nronombre[4];break;}
          	else{
          	/*if($anterior=="cero"){$devolver=$literal." ".$nronombre[2];break;}
          	else {*/$devolver=$literal." ".$nronombre[5];break;}
        case 6:
        	if($literal==""||$literal=="cero"){$devolver=$nronombre[0];break;}
            $literal=str_replace("uno","un",$literal);
           	$devolver=$literal." ".$nronombre[1];   
